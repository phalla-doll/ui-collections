  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="bg-[#1c1c1e] rounded-[32px] p-6 w-[360px] text-white shadow-2xl border border-white/5">
        <h2 className="text-[10px] font-bold tracking-wider text-zinc-500 mb-6">DEVICE STORAGE</h2>
        
        <div className="flex h-10 rounded-xl overflow-hidden mb-8 gap-1 bg-transparent">
          <div className="bg-[#3b82f6] w-[40%] rounded-l-xl"></div>
          <div className="bg-[#10b981] w-[15%]"></div>
        ...
        <div>
          <div className="text-[10px] font-bold tracking-wider text-[#3b82f6] mb-1">AVAILABLE</div>
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-light text-zinc-100">120.29</span>
            <span className="text-sm font-medium text-zinc-500">GB 47%</span>
          </div>
        </div>
      </div>
